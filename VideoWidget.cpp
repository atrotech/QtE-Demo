...
void TVideoWidget::paintEvent(QPaintEvent *)
{
    ...
    p.drawText( width()/2+40 , height()/4 ,  QString(" %1 ").arg(refrenceValue[0]));
    ...
    p.drawText( width()/2+40 , height()/4+30 ,  QString(" %1 ").arg(refrenceValue[1]));
    ...
    p.drawText( width()/2+40 , height()/1.65 ,  QString(" %1 ").arg(refrenceValue[2]));
    ...
    p.drawText( width()/2+40 , height()/1.3-10 , QString(" %1 ").arg("none"));
