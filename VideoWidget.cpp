...
void TVideoWidget::paintEvent(QPaintEvent *)
{
    ...
    p.drawText( width()/4 , height()/3 ,  QString(" %1 ").arg(currentValue[0]));
    p.drawText( width()/4 , height()/3 ,  QString(" %1 ").arg(refrenceValue[0]));
    p.drawPixmap( width()/5 , height()/5 , tickImg);
