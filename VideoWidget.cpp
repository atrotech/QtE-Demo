...
// ----------------------
    ...
    p.drawPixmap( width()/15  , height()/1.82 , tickImg);
    ...
    p.drawPixmap( width()/15  , height()/1.55  , tickImg);
// ----------------------
    ...
    p.drawText( width()/1.3+10 , height()/1.2 , QString(" %1 ").arg("none"));
    p.drawPixmap( width()/15  , height()/1.27 , tickImg);
